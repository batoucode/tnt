// DonnÃ©es pour les scores
const matchScores = [
    { id: 1, team1: "TNT U13 M1", team2: "Tours Basket", score1: 78, score2: 65, date: "15/10/2023", competition: "Championnat DÃ©partemental" },
    { id: 2, team1: "TNT Senior", team2: "Joue-les-Tours", score1: 92, score2: 88, date: "14/10/2023", competition: "PrÃ©-Nationale" },
    { id: 3, team1: "TNT U15 F1", team2: "Amboise BC", score1: 45, score2: 52, date: "13/10/2023", competition: "RÃ©gional FÃ©minin" },
    { id: 4, team1: "TNT U18 M2", team2: "Fondettes", score1: 67, score2: 61, date: "12/10/2023", competition: "Championnat RÃ©gional" }
];

// DonnÃ©es pour les Ã©quipes
const teams = [
    {
        id: 1,
        name: "SÃ©niors M",
        category: "SÃ‰NIOR MASCULIN",
        coach: "A venir",
    ...
    },
    {
        id: 2,
        name: "U13 F",
        category: "U13 FÃ‰MININ",
        coach: "Christian WEINLING",
        training: "Mer 13h30-15h00 (Monnaie), Mer 18h30-20h00 (ChÃ¢teaux-Renault)",
        nextMatch: "Ã€ venir",
        players: []
    },
    {
        ...
        coach: "ClÃ©ment CIAVALDINI-MARET, Nelson HUGUET",
        training: "Lun 18h15-19h30 (Monnaie), Mer 15h30-16h45 (ChÃ¢teau-Renault)",
        nextMatch: "Ã€ venir",
        players: [
            { name: "Cameron LECOUFFE", number: "", position: "" },
            { name: "Noah LEJEUNE", number: "", position: "" },
            { name: "LÃ©o RIDET", number: "", position: "" },
    ...
    },
    {
        ...
        training: "Mar 18h30-20h00 (ChÃ¢teau-R), Mer 15h00-16h30 (Monnaie)",
        nextMatch: "Ã€ venir",
        players: [
            { name: "Septime AGNUS", number: "", position: "" },
            { name: "Maxence BARROIS VOYER", number: "", position: "" },
            { name: "GrÃ©gory BOYER", number: "", position: "" },
    ...
    },
    {
        ...
        training: "Mar 20h00-21h30 (ChÃ¢teau-R), Jeu 18h30-20h00 (ChÃ¢teau-R)",
        nextMatch: "Ã€ venir",
        players: [
    ...
    },
    {
        id: 6,
        name: "U15 F1",
        category: "U15 FÃ‰MININ 1",
        coach: "Mehdi BONNIN",
        training: "Lun 18h45-20h15 (ChÃ¢teau-R), Mer 16h30-18h00 (Monnaie)",
        nextMatch: "Ã€ venir",
        players: [
            { name: "Elina BILLAUD", number: "", position: "" },
            { name: "Leonie BILLY", number: "", position: "" },
            { name: "Alyssia CHEKIOUA", number: "", position: "" },
            { name: "SÃ©lÃ©ne COUPÃ‰", number: "", position: "" },
            { name: "AnaÃ¯s GARONNE", number: "", position: "" },
            ...
            { name: "CÃ©lia MAUNY", number: "", position: "" },
    ...
    },
    {
        ...
        players: [
            ...
            { name: "ZoÃ© PIRON", number: "", position: "" },
...
const galleryImages = [
    { id: 1, url: "https://images.unsplash.com/photo-1544919982-b61976a0d7ed?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", title: "EntraÃ®nement U13" },
    ...
    { id: 3, url: "https://images.unsplash.com/photo-1504450758481-7338eba7524a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", title: "Match U15 FÃ©minin" },
    ...
    { id: 6, url: "https://images.unsplash.com/photo-1546519638-68e109498ffc?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", title: "Esprit d'Ã©quipe" }
];
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Ajout de l'Ã©lÃ©ment pour ajouter des photos
...
function initNavigation() {
    ...
    // Gestion de l'Ã©tat actif des liens selon l'URL (Multi-page)
    ...
    // Gestion du dÃ©filement fluide (pour les ancres internes)
...
function renderScores() {
    ...
    scoresToShow.forEach(match => {
        ...
        // DÃ©terminer le gagnant pour le style
        ...
        scoreCard.innerHTML = `
            ...
            <div class="match-info">
                <p><strong>CompÃ©tition:</strong> ${match.competition}</p>
...
// Ajouter l'Ã©lÃ©ment pour uploader des photos
            ...
            <div class="team-card-body">
                <div class="team-info">
                    <div class="team-info-item">
                        <span>EntraÃ®neur:</span>
                        <span>${team.coach}</span>
                    </div>
                    <div class="team-info-item">
                        <span>EntraÃ®nements:</span>
...
function addNewPhoto() {
    ...
    showNotification(`Photo "${randomTitle}" ajoutÃ©e avec succÃ¨s !`);
}
...
function displayVersion() {
    ...
    if (versionDisplay) {
        // Cette valeur sera mise Ã  jour par l'agent avant chaque commit
...
const siteContent = [
    {
        ...
        url: "index.html",
        keywords: ["accueil", "tnt", "team", "nord", "touraine", "basket", "club", "monnaie", "château-renault"],
        category: "Page"
    },
    {
        title: "Le Club",
        ...
        url: "club.html",
        keywords: ["club", "histoire", "ctc", "coopération", "monnaie", "château-renault", "fusion"],
        category: "Page"
    },
    {
        title: "Scores",
        ...
        url: "scores.html",
        keywords: ["scores", "résultats", "matchs", "victoires", "championnat"],
        category: "Page"
    },
    {
        title: "Galerie",
        ...
        url: "galerie.html",
        keywords: ["galerie", "photos", "images", "entraînement", "match", "événements"],
        category: "Page"
    },
    {
        title: "Équipes",
        ...
        url: "equipes.html",
        keywords: ["équipes", "séniors", "u18", "u15", "u13", "féminin", "masculin", "joueurs"],
        category: "Page"
    },
    {
        title: "Contact",
        ...
        url: "contact.html",
        keywords: ["contact", "email", "téléphone", "adresse", "inscription"],
        category: "Page"
    },
    // Équipes
    ...teams.map(team => ({
        title: team.category,
        description: \Équipe \ - Entraîneur: \. Entraînements: \\,
        url: "equipes.html",
        keywords: [team.name.toLowerCase(), team.category.toLowerCase(), "équipe", "basket", team.coach.toLowerCase()],
        category: "Équipe"
    })),
    // Scores
    ...matchScores.map(match => ({
        title: \\ vs \\,
        description: \Score: \ - \. \ le \\,
        url: "scores.html",
        keywords: [match.team1.toLowerCase(), match.team2.toLowerCase(), "score", "match", match.competition.toLowerCase()],
        category: "Match"
    }))
];
...
function showSuggestions() {
    ...
    // Réattacher les événements aux nouveaux tags
...
function highlightQuery(text, query) {
    ...
    return text.replace(regex, '<strong style="color: var(--accent-orange);">\</strong>');
}
